...
class PhotoTableNodeCell: ASCellNode {
	...
	let avatarImageNode: ASNetworkImageNode = {
        let manager = ASKFImageManager.shareInstance
		let imageNode = ASNetworkImageNode(cache: manager, downloader: manager)
...
extension PhotoTableNodeCell: ASNetworkImageNodeDelegate {
    ...
    func imageNode(_ imageNode: ASNetworkImageNode, didLoad image: UIImage) {
        ...
        self.layer.add(transition, forKey: "AsyncImageNodeDisplayTransition")
    }
